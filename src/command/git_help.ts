...
const printFooter = () => {
    console.log()
    console.log(color.sky("  💡 ") + color.subtext0("Tip: All commands support interactive selection with fuzzy search"))
    console.log(color.sky("  🔗 ") + color.subtext0("Repo: https://github.com/vhxnif/git-alias"))
    console.log()
}
